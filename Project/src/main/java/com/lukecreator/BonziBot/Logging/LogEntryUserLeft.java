...
public class LogEntryUserLeft extends LogEntry {
	
	private static final long serialVersionUID = 1L;

	public LogEntryUserLeft() {
		super(Type.USERLEFT);
	...
	public MessageEmbed toEmbed(EmbedBuilder input) {
		input.setTitle("User Left Server");
	...
	public void loadData(Object dataStructure, BonziBot bb, Consumer<LogEntry> _success, Consumer<Throwable> _failure) {
		if(!(dataStructure instanceof GuildMemberRemoveEvent))
			return;
		
		GuildMemberRemoveEvent event = (GuildMemberRemoveEvent)dataStructure;
