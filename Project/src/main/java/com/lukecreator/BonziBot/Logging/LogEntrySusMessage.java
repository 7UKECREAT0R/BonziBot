...
public class LogEntrySusMessage extends LogEntry {
	
	private static final long serialVersionUID = 1L;

	public LogEntrySusMessage() {
		super(Type.SUSMESSAGE);
	...
	public MessageEmbed toEmbed(EmbedBuilder input) {
		input.setTitle("User Sent Suspicous Message");
	...
	public void performActionWarn(BonziBot bb, ButtonClickEvent event) {
		...
		String warnFor = "Suspicious message: \"" + preview + "\"";
