...
public class StatementModVariable implements ScriptStatement {
	...
	public String getAsCode() {
		return "modulo " + Script.asArgument(this.variableName) + " " + Script.asArgument(value.toString());
	}
	...
	public GuiEditEntry[] getArgs(Script caller, Guild server) {
		return new GuiEditEntry[] {
			...
			new GuiEditEntryText(new StringArg("value"), null, "Value", "The value or variable which will be divided with.")
		};
	}
