...
public class PackageStorage implements Serializable {
	...
	// Max bytes of memory a package can hold. A block is just a user-facing way of saying byte (kinda like 3ds lol)
	public static transient final int MAX_BLOCKS = 0x20000; // ~128 KiB
	...
	public class StorageEntry implements Serializable {
		...
		public StorageEntry(long key, Object data) throws StorageException {
			...
			if(data instanceof ISnowflake) {
				...
				if(data instanceof MessageChannelUnion)
