...
public class StatementPowVariable implements ScriptStatement {
	...
	public String getAsCode() {
		return "pow " + Script.asArgument(this.variableName) + " " + Script.asArgument(this.value.toString());
	}
	...
	public GuiEditEntry[] getArgs(Script caller, Guild server) {
		return new GuiEditEntry[] {
			...
			new GuiEditEntryText(new StringArg("exp"), null, "Exponent", "The exponent to raise the value to.")
		};
	}
	...
	public void execute(ScriptContextInfo info, ScriptExecutor context) {
		if(this.value.getType() == Type.STRING) {
			...
			if(attempt != null) {
				context.memory.operationPowConstant(this.variableName, attempt, this);
				return;
			}
		}
		context.memory.operationPowConstant(this.variableName, this.value, this);
	}
}
