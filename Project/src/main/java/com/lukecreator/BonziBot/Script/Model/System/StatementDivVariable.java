...
public class StatementDivVariable implements ScriptStatement {
	...
	public String getAsCode() {
		return "divide " + Script.asArgument(this.variableName) + " " + Script.asArgument(value.toString());
	}
	...
	public void execute(ScriptContextInfo info, ScriptExecutor context) {
		if(value.getType() == Type.STRING) {
			...
			if(attempt != null) {
				context.memory.operationDivConstant(this.variableName, attempt, this);
				return;
			}
		}
		context.memory.operationDivConstant(this.variableName, this.value, this);
	}
}
